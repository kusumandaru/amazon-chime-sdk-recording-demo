...
const FILENAME = process.env.FILENAME || 'Not present in environment';

console.log(`[recording process] MEETING_URL: ${MEETING_URL} WITH FILENAME: ${FILENAME}`);
...
let fileName = "";
if (FILENAME === "" ) {
    fileName = `${year}/${month}/${day}/${hour}/${fileTimestamp}.mp4`;
} else {
